...
<div class="container-fluid">
    ...
    <div class="row justify-content-md-center">
        <div class="col align-self-center btn-group-vertical">
            <a class="btn btn-success btn-lg" href="print.php?m=<?php echo $m; ?>&p=<?php echo $p; ?>&n=<?php echo $n; ?>" role="button" target="_blank"><input type="hidden" name="hidden_element" value="data"/>Друк</a><br>
